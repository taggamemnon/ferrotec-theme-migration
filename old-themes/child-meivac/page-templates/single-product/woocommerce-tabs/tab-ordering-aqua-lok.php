...
<?php endif; ?>
                  ...
                  <div class="row">
					<div class="col-sm-6">
		               ...
		               <p>If you have questions about pricing and availability, need more information about Ferrotec’s MeiVac Vari-Q throttle valve model <?php echo $product->get_sku(); ?>, or if you have other requirements, you can submit your request using the form below or <a href="/contact-us/">contact your Ferrotec representative directly</a></p>
                     ...
                     <div class="col-sm-6">
                        <?php
                           gravity_form( 'meivac-inquiry', false, false, false );
                            ?>
                     </div>
                  </div>
