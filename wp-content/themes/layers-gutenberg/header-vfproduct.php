...
<?php if (!current_theme_supports('title-tag')) : ?>
  <title>Ferrofluidic Seals | Feedthrough Model: <?php the_field('mNum'); ?> Part Number: <?php the_field('pNum'); ?></title>
<?php endif ?>
      <meta charset="<?php bloginfo('charset'); ?>">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <link rel="canonical" href="https://seals.ferrotec.com/products/ferrofluidic-vacuum-rotary-feedthroughs/<?php the_field('pNum') ?>/">
